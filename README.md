...
## Photo of the polarimeter
![Polarimeter](https://github.com/user-attachments/assets/8763ddee-97b7-435a-bd08-986b0723c0a7)
## Printable details
...
- nuts and washers 10 mm in diameter(number depends on the number of floors of the structure - 4 of each for each floor)
#### Available for order on marketplaces
...
Print out the details(files are laid out on the page). You'll need 3 Stage2 central details, 1 Stage2 ground detail and one piece each for the rest details. Glue the plexiglass tube and the plexiglass platform together tightly. It is important to prevent glue stains from getting under the tube. Mounting or cyanoacrylate glue can be used. Wash the slides with a grease remover and carefully attach the polarizing firm to slide. Also, you should attach the polarizing firm to the Centre detail.
...
Arrange the focused light source between legs and first Stage2 central with tripod holder. Place the glass slides on the first Stage2. Put the plexiglass tube with platform on the second Stage2. Combine the third Stage2 detail, Ring detail and Centre detail into one analysing structure. It's done! To conduct experiments you should make the sugar syrup.
# Measurements
## Working principle
...
# Contact information(for more precise instructions and help)
